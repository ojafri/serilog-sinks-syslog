...
namespace Serilog.Sinks.Syslog
{
    public static class SysLogExtensions
    {
        ...
        /// <returns></returns>
        public static LoggerConfiguration Syslog(this LoggerSinkConfiguration config, string sysLogServer, int port, ProtocolType protocol, bool useSSL=false, string appName=null, int batchSize = 10, int batchPeriodInseconds = 1)
        {
            var sink = new SyslogSink(batchSize, TimeSpan.FromSeconds(batchPeriodInseconds), sysLogServer, port, protocol, useSSL, appName);
